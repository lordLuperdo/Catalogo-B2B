<script setup>
import card_ancheta from "../components/code/card_ancheta.vue"
import card_p from "../components/code/car_product.vue"
import contacto from "../components/code/contacto.vue"
import boton_carrito from "~/components/code/boton_carrito.vue"
...
<div class="md:flex sm:flex-wrap sm:gap-2 sm:justify-center">
    ...
    <card_ancheta v-for="product in products.cofres" key="product"
:name="product.name"
:photo="product.id"
...
<div class="md:flex sm:flex-wrap sm:gap-2 sm:justify-center">
<card_ancheta v-for="product in products.maletines" key="product"
:name="product.name"
:photo="product.id"
:arreglo="product.products"
:price="product.price"
...
<div class=" flex gap-3 items-center justify-center w-full p-4 ">
